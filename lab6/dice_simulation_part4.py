...
number was picked is output in a table format. prints expected and difference
"""
...
def print_output_in_table_format(picks_done, picks_count_dict):
    ...
    while rows_printed <= 12:
        ...
        #  formats the output of the table. (1/11) chance of picking any number in the given sample space.
        print('{:6}{:8}{:10}{:12}{:14}'.format(rows_printed, picks_count_dict[rows_printed],
                                               round(picks_count_dict[rows_printed] / picks_done, 2),
                                               round((1 / 11), 2),
                                               (round(picks_count_dict[rows_printed] / picks_done - (1 / 11), 2))))
